...
import profilePic from "../assets/abi2.jpg";
        ...
        <div className="flex flex-wrap">
            <div className="w-full lg:w-1/2">
                <div className="flex flex-col items-center ">
                    ...
                    initial="hidden"
                    animate="visible" className="my-2 mx-6 max-w-xl py-6 font-light tracking-tighter">{HERO_CONTENT}</motion.p>
                </div>
            </div>
            <div className="w-full lg:w-1/2 lg:p-8">
              <div className="flex justify-center">
                ...
                className="rounded-2xl w-2/3 h-2/3"src={profilePic} alt="Kevin Rush"></motion.img>
              </div>
            </div>
        </div>
    </div>
